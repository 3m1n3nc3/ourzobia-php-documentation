...
Here the user can: 
    ...
    - Add their banking information
    - Change passwords 

Also admin depending on the Admin Level value can: 
    - Access user account from here.
    - Change user status.
    - Set the initial cashout value, that determines if a user has made any cashout from the system.
    - Make the user an admin, Change user's Admin Level.
